...
Copy-Item -Path * -Destination temp_build -Recurse -Exclude "sidebar-app", "*.ps1", "*.sh", "*.zip", ".gitignore", "temp_build", "manifest.json.chrome-bak", "manifest.firefox.json", "offscreen.js", "offscreen.html"
