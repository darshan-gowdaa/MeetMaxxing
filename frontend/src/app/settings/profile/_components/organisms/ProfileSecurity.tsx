...
export const ProfileSecurity = () => {
	 ...
	 className="w-full sm:w-auto px-6 py-3 bg-primary text-on-primary rounded-xl text-sm font-bold hover:brightness-110 disabled:opacity-50 transition-all active:opacity-80 flex items-center justify-center gap-2"
	 >
