...
const Wrapper = ({ children }: { children: React.ReactNode }) => (
 ...
 <div className="bg-white/[0.03] border border-white/[0.08] rounded-3xl p-8 shadow-sm border border-border max-w-md w-full text-center relative z-10">
...
"https://meetmaxxing-api.onrender.com";
 ...
 className="w-full h-12 bg-white text-black font-semibold rounded-xl flex items-center justify-center gap-3 hover:bg-surface-container-highest transition-colors mb-3"
 >
 ...
 className="block w-full h-12 border border-white/10 text-white font-semibold rounded-xl flex items-center justify-center hover:bg-surface-container-highest transition-colors text-sm"
 >
 Sign in with Email
 </Link>
 </Wrapper>
 ...
 <div className="bg-surface-container-high border border-white/10 rounded-xl p-3 text-left">
