...
export function Switch({ checked, onCheckedChange, disabled, className ="", ...props }: SwitchProps) {
 ...
 className={`relative inline-flex h-8 w-14 shrink-0 cursor-pointer items-center rounded-full border-2 transition-colors duration-300 disabled:cursor-not-allowed disabled:opacity-50 ${
