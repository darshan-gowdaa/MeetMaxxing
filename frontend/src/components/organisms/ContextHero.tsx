...
export default function ContextHero({ loading, filesCount, totalSizeKB, setShowUpload }: ContextHeroProps) {
 ...
 className="flex flex-col items-center justify-center min-w-[6rem] px-4 h-20 rounded-[20px] bg-primary-container text-on-primary-container hover:brightness-125 transition-all duration-300 active:opacity-80"
 >
